...
################################################################################
# final concatenating task BOLD series after pre-processing
################################################################################
...
input=$DIR/"code/task_paper/concat/MIL_inputForFinalConcatenation.tsv"

# define search and replace string for file prefix
searchstring="fullpreproc_bold.nii.gz"
replacestring="finconcat_bold.nii.gz"
